...
const ACTIONS = {
  ...
  OPS_CLEANING_DAY_INPUTS_WRITE: 'ops.cleaning.day_inputs_write',
...
const ACTION_MODULE = {
  ...
  [ACTIONS.OPS_CLEANING_DAY_INPUTS_WRITE]: 'cleaning',
...
const POLICY = {
  ...
  [ACTIONS.OPS_CLEANING_DAY_INPUTS_WRITE]: [ROLE_ADMIN, ROLE_OPERATOR],
