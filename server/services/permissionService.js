...
const ACTIONS = {
  ...
  OPS_CLEANING_PAYOUT_READ: 'ops.cleaning.payout_read',
...
const ACTION_MODULE = {
  ...
  [ACTIONS.OPS_CLEANING_PAYOUT_READ]: 'cleaning',
...
const POLICY = {
  ...
  [ACTIONS.OPS_CLEANING_PAYOUT_READ]: [ROLE_ADMIN, ROLE_OPERATOR, ROLE_CLEANER],
