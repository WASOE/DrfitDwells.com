 ...
 *
 * @param {object} evaluation — result of evaluateLocationConflicts
 * @param {object} inventory — result of resolveLocationTargets
 * @returns {Array<{ accommodationLabel: string, reason: string, publicMessage: string }>}
 */
