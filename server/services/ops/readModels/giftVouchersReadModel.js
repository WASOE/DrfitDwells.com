...
function mapListItem(doc) {
  return {
    ...
    physicalCardFeeCents: doc.physicalCardFeeCents || 0,
    ...
    deliveryOption: doc.deliveryOption || null,
    deliveryMode: doc.deliveryMode || 'email',
    cardOccasion: doc.cardOccasion || null,
    cardTemplateId: doc.cardTemplateId || null,
    cardLocale: doc.cardLocale || null,
