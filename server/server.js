...
app.use('/api/public', requireDb, require('./routes/publicLocationEnquiryRoutes'));
...
const shutdown = (signal) => {
  ...
  try {
    const { stopOpsPushSchedulerWorkerForTest } = require('./services/ops/push/opsPushSchedulerWorker');
