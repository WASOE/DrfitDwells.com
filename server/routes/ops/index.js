...
const workWindowsRoutes = require('./modules/workWindowsRoutes');
...
const insightsRoutes = require('./modules/insightsRoutes');
const conversionRoutes = require('./modules/conversionRoutes');
...
router.use('/work-windows', workWindowsRoutes);
