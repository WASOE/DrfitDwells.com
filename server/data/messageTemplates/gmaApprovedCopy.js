...
const VALLEY_EMAIL_BODY = [
  ...
  '',
  '  <p>The last section to The Valley is approximately 2.5 km (about 45 minutes walking) and is not standard car access. It is completed by walk or arranged suitable transfer, depending on prior arrangement and conditions on site.</p>',
  '',
  '  <p><strong>Full arrival guide:</strong><br>',
  '  <a href="{{guideUrl}}">{{guideUrl}}</a></p>',
  '',
...
const VALLEY_WHATSAPP_BODY = [
  ...
  '',
  'The last section to The Valley is approximately 2.5 km (about 45 minutes walking) and is completed by walk or arranged suitable transfer, depending on prior arrangement and conditions on site.',
  '',
  'Full arrival guide:',
  '{{guideUrl}}',
  '',
  ...
  '',
  'Последният участък до The Valley е около 2.5 км (около 45 минути пеша) и се стига пеша или с предварително уговорен подходящ трансфер, според организацията и условията на място.',
  '',
  'Пълен наръчник за пристигане:',
  '{{guideUrl}}',
  '',
...
const ACCESS_VALLEY_EMAIL_BODY = [
  ...
  '  <a href="{{googleMapsUrl}}">{{googleMapsUrl}}</a></p>',
  '',
  '  <p>The last approximately 2.5 km (about 45 minutes walking) is not standard car access. You can walk from the parking, or we can arrange a suitable transfer depending on timing and conditions.</p>',
  '',
