...
const MIGRATED_OPS_FILES = [
  ...
  'src/pages/ops/OpsManualReviewBacklog.jsx',
  'src/pages/ops/OpsManualReviewBacklog.css',
  'src/pages/ops/OpsSyncCenter.jsx',
  'src/pages/ops/OpsSyncCenter.css',
  'src/pages/ops/OpsCommunicationOversight.jsx',
  'src/pages/ops/OpsCommunicationOversight.css',
  'src/pages/ops/OpsPayments.jsx',
  'src/pages/ops/OpsPayments.css',
  'src/pages/ops/OpsUsers.jsx',
  'src/pages/ops/OpsUsers.css',
  'src/pages/ops/OpsCabinsList.jsx',
  'src/pages/ops/OpsCabinsList.css',
  'src/pages/ops/OpsCabins.jsx',
  'src/pages/ops/OpsCabinDetail.css',
  'src/pages/ops/cabins/OpsReadOnlyDetailSection.jsx',
  'src/pages/ops/cabins/ArchiveCabinModal.jsx',
  ...
  'src/pages/ops/OpsMessaging.css',
  ...
  'src/pages/ops/cleaning/OpsCleaningCalendar.jsx',
  'src/pages/ops/cleaning/OpsCleaningCalendar.css',
  'src/pages/ops/cleaning/OpsCleaningPaymentPanel.jsx',
  'src/pages/ops/cleaning/OpsCleaningPayoutBreakdown.jsx',
  'src/pages/ops/cleaning/OpsCleaningDailyFeeCard.jsx',
  'src/pages/ops/cleaning/OpsCleaningLineItemsTable.jsx',
  'src/pages/ops/OpsInsights.jsx',
  'src/pages/ops/OpsInsightsPerformance.jsx',
  'src/pages/ops/OpsInsights.css',
  'src/pages/ops/OpsCreatorPartners.jsx',
  'src/pages/ops/OpsCreatorPartners.css',
  'src/pages/ops/OpsConversion.jsx',
  'src/pages/ops/OpsConversion.css',
