...
const bottomStripConfig = [
  ...
  { image: '/uploads/Icons%20trival/camp.png', i18nKey: 'footer.bottomStrip.natureFirst' },
  { image: '/uploads/Icons%20trival/pipe.png', i18nKey: 'footer.bottomStrip.slowDown' },
  { image: '/uploads/Icons%20trival/dance%20(1).png', i18nKey: 'footer.bottomStrip.stayWild' }
];
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-8 md:gap-12 lg:gap-16 xl:gap-20 mb-6 lg:mb-8">
          <div className="flex flex-col">
            ...
            <p
              className="font-['Montserrat'] text-[#111] mb-8 lg:mb-10"
              style={{ fontSize: '14px', fontWeight: 400, opacity: 0.8, lineHeight: '1.6', maxWidth: '400px' }}
            >
              {tc('footer.subcopy')}
            </p>
            ...
            <form className="mb-10 lg:mb-14">
              <div className="flex items-baseline border-b border-[#111] pb-2 mb-4" style={{ maxWidth: '100%' }}>
                <input
                  type="email"
                  placeholder={tc('footer.emailPlaceholder')}
                ...
                <button
                  ...
                  aria-label={tc('footer.subscribeAria')}
                >
              ...
              <div className="flex items-start gap-2">
                ...
                <label
                  ...
                  style={{ fontSize: '11px', fontWeight: 400, opacity: 0.7, lineHeight: '1.5' }}
                >
                  <Trans
                    t={tc}
                    ns="common"
                    ...
                    components={[
                      <Link key="privacy" to={localizePath('/privacy', language)} className="underline hover:opacity-60" />,
                      <Link key="terms" to={localizePath('/terms', language)} className="underline hover:opacity-60" />
                    ]}
                  />
                </label>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            <div className="flex flex-col">
              <h3
                className="font-['Montserrat'] text-[#111] uppercase mb-5"
                style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.18em', opacity: 0.75 }}
              >
                {tc('footer.menu')}
              </h3>
              ...
              <ul>
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    ...
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('home')}
                  </Link>
                </li>
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/cabin', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('cabin')}
                ...
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/valley', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('valley')}
                ...
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/about', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('about')}
                ...
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/build', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('build')}
            ...
            <div className="flex flex-col">
              ...
              <ul>
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/off-grid-cabins-bulgaria', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('exploreOffGrid')}
                ...
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/rhodopes-cabin-retreat', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('exploreRhodopes')}
                ...
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/bansko-remote-work-retreat', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('exploreBansko')}
                ...
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/retreat-venue-bulgaria', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tn('exploreRetreatVenue')}
                  </Link>
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <ul>
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/career', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tc('footer.careers')}
                ...
                <li style={{ marginBottom: 'clamp(16px, 2vw, 28px)' }}>
                  <Link
                    to={localizePath('/press', language)}
                    className="font-['Montserrat'] text-[#111] hover:opacity-60 transition-opacity uppercase"
                    style={{ fontSize: '12px', letterSpacing: '0.12em', fontWeight: 600, lineHeight: '2.5' }}
                  >
                    {tc('footer.press')}
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-3">
                <h3
                  className="font-['Montserrat'] text-[#111] uppercase mb-3"
                  style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.18em', opacity: 0.75 }}
                >
                  {tc('footer.followUs')}
                </h3>
                <div className="flex items-center gap-3">
                  <a href={INSTAGRAM_URL} className="text-[#111] hover:opacity-60 transition-opacity" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  ...
                  <a href={FACEBOOK_URL} className="text-[#111] hover:opacity-60 transition-opacity" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-b border-[#111] py-16 lg:py-20" style={{ borderColor: 'rgba(17, 17, 17, 0.25)' }}>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10 lg:gap-12">
            <div className="flex flex-col items-center text-center md:items-start md:text-left px-6 md:px-10">
              ...
              <div className="text-[10px] uppercase tracking-[0.3em] text-[#1c1917] mb-2" style={{ opacity: 0.55 }}>
                ★★★★★
              </div>
              <div className="text-[10px] uppercase tracking-[0.25em] text-stone-500 font-medium">{tc('footer.ratings.topHomes')}</div>
            </div>

            <div className="flex flex-col items-center text-center px-6 md:px-10">
              <div className="h-12 flex items-center mb-4 mt-2">
                <span className="text-2xl font-['Montserrat'] text-[#1c1917] tracking-tight" style={{ fontWeight: 700 }}>
                  Booking.com
                </span>
              </div>
              <div className="text-4xl font-['Montserrat'] text-[#1c1917] mb-1" style={{ fontWeight: 600 }}>
              ...
              <div className="text-[10px] uppercase tracking-[0.25em] text-stone-500 font-medium">{tc('footer.ratings.travellerAwards')}</div>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:items-end md:text-right px-6 md:px-10">
              ...
              <div className="text-[10px] uppercase tracking-[0.25em] text-stone-500 font-medium">{tc('footer.ratings.travelersChoice')}</div>
            </div>
          </div>
        </div>

        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16 py-6 mt-24 lg:mt-28">
          {bottomStripConfig.map((item, index) => {
            const text = tc(item.i18nKey);
            return (
              <div key={index} className="flex items-center gap-3 md:gap-4" style={{ opacity: 0.5 }}>
                <img src={item.image} alt={text} className="w-8 h-8 md:w-9 md:h-9 object-contain" />
