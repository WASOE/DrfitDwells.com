...
export const OPS_SHARED_TOKEN_VALUES = {
  ...
  '--ops-lh-display': '32px',
  '--ops-font-display': '"Montserrat", Inter, system-ui, -apple-system, "Segoe UI", Roboto, sans-serif',
  '--ops-size-dashboard-lead': 'clamp(52px, 6vw, 88px)',
  '--ops-lh-dashboard-lead': '0.95',
  '--ops-size-page-title-premium': '24px',
  '--ops-lh-page-title-premium': '30px',
  '--ops-size-surface-title-premium': '17px',
  '--ops-lh-surface-title-premium': '22px',
  '--ops-size-title': '18px',
  '--ops-lh-title': '24px',
