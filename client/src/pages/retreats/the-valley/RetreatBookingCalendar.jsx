            ...
            <div className="space-y-3">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(event) =>
                    setFormData((prev) => ({
                      ...prev,
                      quoteDeliveryRequested: event.target.checked
                    }))
                  }
                  className="mt-0.5 w-4 h-4 rounded border-gray-300 text-gray-900 focus:ring-gray-900"
                />
                <span className="text-xs text-gray-700 leading-relaxed">
                  Email me this quote. This only covers sending the quote I requested — not marketing
                  or booking reminders.
                </span>
              </label>
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(event) =>
                    setFormData((prev) => ({
                      ...prev,
                      bookingReminderConsent: event.target.checked
                    }))
                  }
                  className="mt-0.5 w-4 h-4 rounded border-gray-300 text-gray-900 focus:ring-gray-900"
                />
                <span className="text-xs text-gray-700 leading-relaxed">
                  If I do not finish booking, you may email me a limited reminder about this stay. This
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(event) =>
                    setFormData((prev) => ({ ...prev, marketingConsent: event.target.checked }))
                  }
                  className="mt-0.5 w-4 h-4 rounded border-gray-300 text-gray-900 focus:ring-gray-900"
                />
                <span className="text-xs text-gray-700 leading-relaxed">
