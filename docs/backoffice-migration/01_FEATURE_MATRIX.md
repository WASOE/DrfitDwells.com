...
| Cabin create/edit | `/admin/cabins/new`, `/admin/cabins/:id` | `client/src/pages/admin/CabinEdit.jsx` | `POST/PATCH /api/admin/cabins` | `createCabin`, `updateCabin` | `Cabin`, `Booking`, `CabinType`, `Unit` | yes | read-focused OPS cabins | `/ops/cabins/:id` | move | high | **Legacy until OPS cabin CRUD parity** (`/admin/cabins/new` + `/admin/cabins/:id` unchanged). Cabin types: `/admin/cabin-types*` unchanged. | CRUD | 2 |
