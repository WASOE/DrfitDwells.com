...
| Cabin image upload | `/admin/cabins/:id` | `CabinEdit.jsx`, `client/src/api/adminImages.js` | `POST /api/admin/cabins/:id/images` | `server/services/cabins/cabinMediaService.js` (called by admin + ops routes) | `Cabin` | yes | `POST /api/ops/cabins/:id/images` (Batch 5B ✓ backend only) | `/ops/cabins/:id` | move (reuse handler or service) | high | `syncMultiUnitGalleryToCabinType`, files | upload | 2 |
| Cabin image reorder | `/admin/cabins/:id` | same | `PATCH /api/admin/cabins/:id/images/reorder` | `cabinMediaService.js` (called by admin + ops routes) | `Cabin` | yes | `PATCH /api/ops/cabins/:id/images/reorder` (Batch 5B ✓ backend only) | `/ops/cabins/:id` | move | medium | same | reorder | 2 |
| Cabin image patch | `/admin/cabins/:id` | same | `PATCH /api/admin/cabins/:id/images/:imageId` | `cabinMediaService.js` (called by admin + ops routes) | `Cabin` | yes | `PATCH /api/ops/cabins/:id/images/:imageId` (Batch 5B ✓ backend only) | `/ops/cabins/:id` | move | medium | tags whitelist | meta edit | 2 |
