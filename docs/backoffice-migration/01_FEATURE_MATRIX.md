...
| Cabin image upload | `/admin/cabins/:id` | `CabinEdit.jsx`, `client/src/api/adminImages.js` | `POST /api/admin/cabins/:id/images` | `server/services/cabins/cabinMediaService.js` (called by `adminRoutes.js`) | `Cabin` | yes | none | `/ops/cabins/:id` | move (reuse handler or service) | high | `syncMultiUnitGalleryToCabinType`, files | upload | 2 |
| Cabin image reorder | `/admin/cabins/:id` | same | `PATCH /api/admin/cabins/:id/images/reorder` | `cabinMediaService.js` (called by `adminRoutes.js`) | `Cabin` | yes | none | `/ops/cabins/:id` | move | medium | same | reorder | 2 |
| Cabin image patch | `/admin/cabins/:id` | same | `PATCH /api/admin/cabins/:id/images/:imageId` | `cabinMediaService.js` (called by `adminRoutes.js`) | `Cabin` | yes | none | `/ops/cabins/:id` | move | medium | tags whitelist | meta edit | 2 |
| Cabin image batch | `/admin/cabins/:id` | same | `PATCH /api/admin/cabins/:id/images/batch` | `cabinMediaService.js` (called by `adminRoutes.js`) | `Cabin` | yes | none | `/ops/cabins/:id` | move | medium | batch validation | batch | 2 |
| Cabin image delete | `/admin/cabins/:id` | same | `DELETE /api/admin/cabins/:id/images/:imageId` | `cabinMediaService.js` + `permissionService` (called by `adminRoutes.js`) | `Cabin`, `AuditEvent` | yes | none | `/ops/cabins/:id` | move | high | audit required | delete | 2 |
