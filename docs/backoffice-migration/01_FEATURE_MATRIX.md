...
| Cabin image patch | `/admin/cabins/:id` | same | `PATCH /api/admin/cabins/:id/images/:imageId` | `cabinMediaService.js` (called by admin + ops routes) | `Cabin` | yes | `PATCH /api/ops/cabins/:id/images/:imageId` (Batch 5B ✓ backend, Batch 5C ✓ cover-only UI) | `/ops/cabins/:id` | move | medium | tags whitelist | meta edit | 2 |
...
| Cabin image delete | `/admin/cabins/:id` | same | `DELETE /api/admin/cabins/:id/images/:imageId` | `cabinMediaService.js` + `permissionService` (called by admin + ops routes) | `Cabin`, `AuditEvent` | yes | `DELETE /api/ops/cabins/:id/images/:imageId` (Batch 5B ✓ backend only) | `/ops/cabins/:id` | move | high | audit required | delete | 2 |
