...
| EX-CLEAN-01 | Ops Cleaning Calendar (`/ops/cleaning`) | §6.5 spatial exception; page width `full` | Approved spatial cleaning schedule: month strip + day task list + payout side panels need full operational width. Cleaner shell/locale remain dedicated; not a narrow settings layout. | Jose Antonio Fiallo León | 2026-09-20 | 2026-12-20 | active |
